...
class VoiceConversionModel(nn.Module):
    ...
    def train_step(self, source,mel, goal,source_len, goal_len, goal_mel,cnt, ep):
        ...
        if  cnt%200==0 or cnt == 2 or cnt ==100:
        ...
        # Dodaj karę za gradienty do straty dyskryminatora
        LAMBDA = 10  # Współczynnik kary za gradienty
        loss_disc = loss_disc + LAMBDA * gradient_penalty
        w_pred = 10
        w_asr = 0
        w_rec = 45
        w_gen = 1
