...
if __name__ == "__main__":
    audio_file = '..\\data\\parts6s\\common_voice_en_38145673.wav'
    audio_params = AudioFeaturesParams()
    audio = load_and_preprocess_audio(audio_file, audio_params.sampling_rate)
    mel_spec = mel_spectrogram(audio, audio_params)
